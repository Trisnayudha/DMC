...
This is a confirmation that you are registered to attend our event on Tuesday, 29 April 2025 at ' . $event->location . ', starting at ' . date('h.i a', strtotime($event->start_time)) . ' - ' . date('h.i a', strtotime($event->end_time)) . ' (WIB)
