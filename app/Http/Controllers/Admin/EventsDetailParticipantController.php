...
This is a confirmation that you are registered to attend our event on TOMORROW, 14 April 2026 at ' . $event->location . ', starting at ' . date('h.i a', strtotime($event->start_time)) . ' - ' . date('h.i a', strtotime($event->end_time)) . ' (WIB) and followed by Networking Dinner and Drinks.
