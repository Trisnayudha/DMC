...
<body>
    ...
    <div class="body">
        <div class="header-email">
            <img src="{{ asset('image/banner71_revisi5.png') }}" alt="Image" class="img-logo">
        </div>
        <div class="body-email">
            ...
            <table class="table">
                ...
                <tr>
                    <th style="white-space: nowrap; width: 1%; padding-right: 0;">Name</th>
                    <th style="white-space: nowrap; width: 1%; padding-left: 4px; padding-right: 0;">:</th>
                    <td style="padding-left: 4px;">{{ $users_name }}</td>
                </tr>
                <tr>
                    <th style="white-space: nowrap; width: 1%; padding-right: 0;">Position</th>
                    <th style="white-space: nowrap; width: 1%; padding-left: 4px; padding-right: 0;">:</th>
                    <td style="padding-left: 4px;">{{ $job_title }}</td>
                </tr>
                <tr>
                    <th style="white-space: nowrap; width: 1%; padding-right: 0;">Company</th>
                    <th style="white-space: nowrap; width: 1%; padding-left: 4px; padding-right: 0;">:</th>
                    <td style="padding-left: 4px;">{{ $company_name }}</td>
                </tr>
                <tr>
                    <th style="white-space: nowrap; width: 1%; padding-right: 0;">Email</th>
                    <th style="white-space: nowrap; width: 1%; padding-left: 4px; padding-right: 0;">:</th>
                    <td style="padding-left: 4px;">{{ $users_email }}</td>
                </tr>
                <tr>
                    <th style="white-space: nowrap; width: 1%; padding-right: 0;">Mobile Number</th>
                    <th style="white-space: nowrap; width: 1%; padding-left: 4px; padding-right: 0;">:</th>
