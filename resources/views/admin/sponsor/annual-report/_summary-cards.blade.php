{{-- ═══ SUMMARY CARDS ═══
     Dua kelompok supaya terbaca dalam sekali pandang (UI saja, logika tidak berubah):
     - Group A "Positive Progress" : Renewal / Upgrade / New Sponsor (rincian deal sukses)
     - Group B "Pipeline Status"   : Confirmed → Pending → Lost (kondisi bisnis keseluruhan)
     Confirmed = Renewal + Upgrade + New; Pending & Lost di luar hitungan Confirmed. --}}
@php
    $pkgMeta = [
...
<div class="d-flex align-items-center mb-2" style="gap:8px;">
    ...
    <span style="font-size:11px;color:#aaa;">confirmed → pending → lost</span>
</div>
<div class="row">
    {{-- Confirmed --}}
    <div class="col-lg-4 col-md-6 col-sm-6 mb-4 d-flex">
    ...
    {{-- Pending (klik menuju tab pending) --}}
    <div class="col-lg-4 col-md-6 col-sm-6 mb-4 d-flex">
