        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="">News Category Management</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>News Category Management</h4>
                            </div>
                            <div class="card-body">
                                @if ($errors->any())
    ...
    <script type="text/javascript">
        $(document).ready(function($) {
            ...
            $('#addNewCategory').click(function() {
                ...
                $('#ajaxCategoryModel').html("Add Category News");
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $('#ajaxCategoryModel').html("Edit Category News");
                        $('#category-model').modal('show');
                        $('#id').val(res.id);
                        $('#category_name').val(res.name_category);
                    }
                });
            });
