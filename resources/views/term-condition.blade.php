...
<head>
    ...
    <title>Term n Condition</title>
</head>

<body>
    <h2><strong>Terms and Conditions</strong></h2>

    <p>Welcome to www.djakarta-miningclub.com!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Djakarta - Mining Club's Website,
        located at https://djakarta-miningclub.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
        www.djakarta-miningclub.com if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>We employ the use of cookies. By accessing www.djakarta-miningclub.com, you agreed to use cookies in agreement
        with the Djakarta - Mining Club's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, Djakarta - Mining Club and/or its licensors own the intellectual property rights for all
        material on www.djakarta-miningclub.com. All intellectual property rights are reserved. You may access this from
        www.djakarta-miningclub.com for your own personal use subjected to restrictions set in these terms and
        conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from www.djakarta-miningclub.com</li>
        <li>Sell, rent or sub-license material from www.djakarta-miningclub.com</li>
        <li>Reproduce, duplicate or copy material from www.djakarta-miningclub.com</li>
        <li>Redistribute content from www.djakarta-miningclub.com</li>
    </ul>


    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. Djakarta - Mining Club does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions of Djakarta - Mining Club,its agents
        and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Djakarta - Mining Club shall not be liable for the Comments or for any
    ...
    <p>Djakarta - Mining Club reserves the right to monitor all Comments and to remove any Comments which can be
    ...
    <p>You hereby grant Djakarta - Mining Club a non-exclusive license to use, reproduce, edit and authorize others to
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Djakarta
        - Mining Club; and (d) the link is in the context of general resource information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to Djakarta - Mining Club. Please include your name, your organization name,
    ...
    <p>No use of Djakarta - Mining Club's logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
