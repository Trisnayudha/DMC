...
<head>
    ...
    <meta name="image" property="og:image" content="https://membership.djakarta-miningclub.com{{ $image }}">
    ...
    {{-- <script>
        $(document).ready(function() {
            Swal.fire({
                ...
                text: "Thank you for your interest to Analyzing Credit Risks, Climate Trends, and Market Insights in Metals, we would like to inform you that our capacity is already full and we look forward to welcoming you to our next event.",
