...
Route::get('survey/the-71st-djakarta-mining-club-networking-event', function () {
...
Route::post('/survey/the-71st-djakarta-mining-club-networking-event', [SurveyController::class, 'store'])->name('survey.store');
...
Route::prefix('admin')->middleware(['cms_auth'])->group(function () {
    ...
    Route::post('sponsors-representative-count/{paymentId}/resend-ticket', [SponsorCountRepresentativeController::class, 'resendTicket'])->name('sponsors.representative.resend_ticket');
    ...
    Route::post('users/{id}/toggle-two-step', [UsersController::class, 'toggleTwoStep'])->name('users.toggle_two_step');
    Route::get('users/bulk-two-step-import/template', [UsersController::class, 'bulkTwoStepImportTemplate'])->name('users.bulk_two_step_import.template');
    Route::post('users/bulk-two-step-import', [UsersController::class, 'bulkTwoStepImport'])->name('users.bulk_two_step_import');
